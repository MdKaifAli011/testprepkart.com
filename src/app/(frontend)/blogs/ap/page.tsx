  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="text-5xl font-bold mb-4 gradient-text">AP Courses Blogs</h1>
          <p className="text-gray-600 text-lg">Advanced Placement tips and strategies</p>
        </div>
