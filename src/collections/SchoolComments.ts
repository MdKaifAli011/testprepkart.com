...
export const SchoolComments: CollectionConfig = {
  slug: 'school_comments',
  admin: {
    useAsTitle: 'comment_author',
    defaultColumns: ['comment_author', 'comment_post_ID', 'comment_date', 'status', 'createdAt'],
    description: 'Comments on school exam blog posts',
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        description: 'Related school blog (mapped from comment_post_ID)',
      },
    },
    {
      name: 'comment_author',
